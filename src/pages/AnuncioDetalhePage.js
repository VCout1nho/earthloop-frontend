// src/pages/AnuncioPublicoPage.js
// Página pública de um anúncio — acessada via link compartilhado
// Mostra o anúncio completo + call to action para se cadastrar
...
export default function AnuncioPublicoPage() {
  const { id } = useParams();
